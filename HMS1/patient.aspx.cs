...
namespace HMS1
{
    public partial class patient : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            con.Open();
            SqlCommand cmd = new SqlCommand("insert into patient values (@ID,@Name,@Disease,@AppointedDoctor)", con);
            cmd.Parameters.AddWithValue("@ID", TextBox1.Text);
            cmd.Parameters.AddWithValue("@Name", TextBox2.Text);
            cmd.Parameters.AddWithValue("@Disease", TextBox3.Text);
            cmd.Parameters.AddWithValue("@AppointedDoctor", TextBox4.Text);
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("UPDATE patient SET Name = @Name, Disease = @Disease, AppointedDoctor = @AppointedDoctor WHERE ID = @ID", con);
                cmd.Parameters.AddWithValue("@ID", TextBox1.Text);
                cmd.Parameters.AddWithValue("@Name", TextBox2.Text);
                cmd.Parameters.AddWithValue("@Disease", TextBox3.Text);
                cmd.Parameters.AddWithValue("@AppointedDoctor", TextBox4.Text);

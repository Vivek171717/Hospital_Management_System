<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="patient.aspx.cs" Inherits="HMS1.patient" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="content">
            ...
            <div class="controls">
                <div class="first1">
                &emsp;&emsp;&emsp;&emsp;&ensp;<asp:Label ID="Label1" runat="server" Text="Patient ID"></asp:Label>
                <asp:TextBox ID="TextBox1" runat="server"></asp:TextBox>
                </div>
                <div class="first2">
                &emsp;&ensp;<asp:Label ID="Label2" runat="server" Text="Patient Name"></asp:Label>
                ...
                <div class="second2">
                <asp:Label ID="Label4" runat="server" Text="Doctor Appointed"></asp:Label>
            ...
            <div class="table">
                <asp:GridView ID="GridView1" runat="server" CssClass="gridview" AutoGenerateColumns="false">
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="AppointedDoctor" HeaderText="Doctor Appointed" />
                    </Columns>
                </asp:GridView>
            </div>
        </div>

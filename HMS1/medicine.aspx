<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="medicine.aspx.cs" Inherits="HMS1.medicine" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="content">
            ...
            <div class="controls">
                <div class="first1">
                &emsp;&emsp;&emsp;&emsp;&emsp;&ensp;<asp:Label ID="Label1" runat="server" Text="Name"></asp:Label>
                ...
                <div class="second2">
                <asp:Label ID="Label4" runat="server" Text="Quantity Required"></asp:Label>
            ...
            <div class="table">
                <asp:GridView ID="GridView1" runat="server" CssClass="gridview" AutoGenerateColumns="false">
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="mprice" HeaderText="Cost Per Unit" />
                        <asp:BoundField DataField="mavailable" HeaderText="Units Available" />
                        <asp:BoundField DataField="mneed" HeaderText="Units Required" />
                    </Columns>
                </asp:GridView>
            </div>
        </div>
